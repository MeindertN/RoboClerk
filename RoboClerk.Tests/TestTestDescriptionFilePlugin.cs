...
namespace RoboClerk.Tests
{
    ...
    internal class TestTestDescriptionFilePlugin
    {
        ...
        {
            string configFile = @$"
FileLocations = [""{TestingHelpers.ConvertFileName(@"c:/temp/system_descriptions.json")}"", ""{TestingHelpers.ConvertFileName(@"c:/temp/unit_descriptions.json")}""]
";
            ...
            {
                { TestingHelpers.ConvertFileName(@"c:\test\TestDescriptionFilePlugin.toml"), new MockFileData(configFile) },
                { TestingHelpers.ConvertFileName(@"c:\temp\system_descriptions.json"), new MockFileData(systemDescriptionsJson) },
                { TestingHelpers.ConvertFileName(@"c:\temp\unit_descriptions.json"), new MockFileData(unitDescriptionsJson) }
            });
        ...
        public void TestDescriptionFilePlugin_MissingConfigFile()
        {
            ...
            {
                { TestingHelpers.ConvertFileName(@"c:\temp\descriptions.json"), new MockFileData("[]") }
            });

            var plugin = new RoboClerk.TestDescriptionFilePlugin.TestDescriptionFilePlugin(fileSystemWithoutConfig);
        ...
        public void TestDescriptionFilePlugin_MalformedJson()
        {
            ...
            var testFileSystem = new MockFileSystem(new Dictionary<string, MockFileData>
            {
                ...
                { TestingHelpers.ConvertFileName(@"c:\temp\system_descriptions.json"), new MockFileData(malformedJson) },
        ...
        public void TestDescriptionFilePlugin_MissingRequiredFields()
        {
            ...
            {
                { TestingHelpers.ConvertFileName(@"c:\test\TestDescriptionFilePlugin.toml"), fileSystem.File.ReadAllText(TestingHelpers.ConvertFileName(@"c:\test\TestDescriptionFilePlugin.toml")) },
                { TestingHelpers.ConvertFileName(@"c:\temp\system_descriptions.json"), new MockFileData(jsonWithMissingFields) },
                { TestingHelpers.ConvertFileName(@"c:\temp\unit_descriptions.json"), new MockFileData("[]") }
            });
        ...
        public void TestDescriptionFilePlugin_MissingUnitTestRequiredFields()
        {
            ...
            {
                { TestingHelpers.ConvertFileName(@"c:\test\TestDescriptionFilePlugin.toml"), fileSystem.File.ReadAllText(TestingHelpers.ConvertFileName(@"c:\test\TestDescriptionFilePlugin.toml")) },
                { TestingHelpers.ConvertFileName(@"c:\temp\system_descriptions.json"), new MockFileData("[]") },
                { TestingHelpers.ConvertFileName(@"c:\temp\unit_descriptions.json"), new MockFileData(jsonWithMissingUnitFields) }
            });
        ...
        public void TestDescriptionFilePlugin_SystemTestOptionalFields()
        {
            ...
            {
                { TestingHelpers.ConvertFileName(@"c:\test\TestDescriptionFilePlugin.toml"), fileSystem.File.ReadAllText(TestingHelpers.ConvertFileName(@"c:\test\TestDescriptionFilePlugin.toml")) },
                { TestingHelpers.ConvertFileName(@"c:\temp\system_descriptions.json"), new MockFileData(systemTestWithoutOptional) },
                { TestingHelpers.ConvertFileName(@"c:\temp\unit_descriptions.json"), new MockFileData("[]") }
            });
        ...
        public void TestDescriptionFilePlugin_EmptyTraceArray()
        {
            ...
            {
                { TestingHelpers.ConvertFileName(@"c:\test\TestDescriptionFilePlugin.toml"), fileSystem.File.ReadAllText(TestingHelpers.ConvertFileName(@"c:\test\TestDescriptionFilePlugin.toml")) },
                { TestingHelpers.ConvertFileName(@"c:\temp\system_descriptions.json"), new MockFileData(jsonWithEmptyTrace) },
                { TestingHelpers.ConvertFileName(@"c:\temp\unit_descriptions.json"), new MockFileData("[]") }
            });
        ...
        public void TestDescriptionFilePlugin_DetailedErrorMessages()
        {
            ...
            var testFileSystem = new MockFileSystem(new Dictionary<string, MockFileData>
            {
                { TestingHelpers.ConvertFileName(@"c:\test\TestDescriptionFilePlugin.toml"), fileSystem.File.ReadAllText(TestingHelpers.ConvertFileName(@"c:\test\TestDescriptionFilePlugin.toml")) },
                { TestingHelpers.ConvertFileName(@"c:\temp\system_descriptions.json"), new MockFileData("[]") },
                { TestingHelpers.ConvertFileName(@"c:\temp\unit_descriptions.json"), new MockFileData(jsonWithMissingAcceptance) }
            });
        ...
        public void TestDescriptionFilePlugin_MissingNameField()
        {
            ...
            {
                { TestingHelpers.ConvertFileName(@"c:\test\TestDescriptionFilePlugin.toml"), fileSystem.File.ReadAllText(TestingHelpers.ConvertFileName(@"c:\test\TestDescriptionFilePlugin.toml")) },
                { TestingHelpers.ConvertFileName(@"c:\temp\system_descriptions.json"), new MockFileData(jsonWithMissingName) },
                { TestingHelpers.ConvertFileName(@"c:\temp\unit_descriptions.json"), new MockFileData("[]") }
            });
        ...
        public void TestDescriptionFilePlugin_MissingDescriptionField()
        {
            ...
            {
                { TestingHelpers.ConvertFileName(@"c:\test\TestDescriptionFilePlugin.toml"), fileSystem.File.ReadAllText(TestingHelpers.ConvertFileName(@"c:\test\TestDescriptionFilePlugin.toml")) },
                { TestingHelpers.ConvertFileName(@"c:\temp\system_descriptions.json"), new MockFileData(jsonWithMissingDescription) },
                { TestingHelpers.ConvertFileName(@"c:\temp\unit_descriptions.json"), new MockFileData("[]") }
            });
...
AND: The user should see a welcome message",
            ...
            {
                { TestingHelpers.ConvertFileName(@"c:\test\TestDescriptionFilePlugin.toml"), fileSystem.File.ReadAllText(TestingHelpers.ConvertFileName(@"c:\test\TestDescriptionFilePlugin.toml")) },
                { TestingHelpers.ConvertFileName(@"c:\temp\system_descriptions.json"), new MockFileData(complexGwtJson) },
                { TestingHelpers.ConvertFileName(@"c:\temp\unit_descriptions.json"), new MockFileData("[]") }
            });
