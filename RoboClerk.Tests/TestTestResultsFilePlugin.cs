...
namespace RoboClerk.Tests
{
    ...
    internal class TestTestResultsFilePlugin
    {
        ...
        {
            string configFile = $@"
FileLocations = [""{TestingHelpers.ConvertFilePath(@"c:/temp/system_results.json")}"", ""{TestingHelpers.ConvertFilePath(@"c:/temp/unit_results.json")}""]
";
            ...
            {
                { TestingHelpers.ConvertFilePath(@"c:\test\TestResultsFilePlugin.toml"), new MockFileData(configFile) },
                { TestingHelpers.ConvertFilePath(@"c:\temp\system_results.json"), new MockFileData(systemResultsJson) },
                { TestingHelpers.ConvertFilePath(@"c:\temp\unit_results.json"), new MockFileData(unitResultsJson) }
            });
        ...
        {
            var plugin = new RoboClerk.TestResultsFilePlugin.TestResultsFilePlugin(new LocalFileSystemPlugin(fileSystem));
        ...
        public void TestResultsFilePlugin_MissingConfigFile()
        {
            ...
            {
                { TestingHelpers.ConvertFilePath(@"c:\temp\results.json"), new MockFileData("[]") }
            });

            var plugin = new RoboClerk.TestResultsFilePlugin.TestResultsFilePlugin(new LocalFileSystemPlugin(fileSystemWithoutConfig));
        ...
        public void TestResultsFilePlugin_MalformedJson()
        {
            ...
            {
                { TestingHelpers.ConvertFilePath(@"c:\test\TestResultsFilePlugin.toml"), fileSystem.File.ReadAllText(TestingHelpers.ConvertFilePath(@"c:\test\TestResultsFilePlugin.toml")) },
                { TestingHelpers.ConvertFilePath(@"c:\temp\system_results.json"), new MockFileData(malformedJson) },
                { TestingHelpers.ConvertFilePath(@"c:\temp\unit_results.json"), new MockFileData("[]") }
            });

            var plugin = new RoboClerk.TestResultsFilePlugin.TestResultsFilePlugin(new LocalFileSystemPlugin(testFileSystem));
            plugin.InitializePlugin(configuration);
        ...
        public void TestResultsFilePlugin_MissingRequiredFields()
        {
            ...
            {
                { TestingHelpers.ConvertFilePath(@"c:\test\TestResultsFilePlugin.toml"), fileSystem.File.ReadAllText(TestingHelpers.ConvertFilePath(@"c:\test\TestResultsFilePlugin.toml")) },
                { TestingHelpers.ConvertFilePath(@"c:\temp\system_results.json"), new MockFileData(jsonWithMissingId) },
                { TestingHelpers.ConvertFilePath(@"c:\temp\unit_results.json"), new MockFileData("[]") }
            });
        ...
        public void TestResultsFilePlugin_ClearsPreviousResults()
        {
            ...
            mockFileSystem.RemoveFile(TestingHelpers.ConvertFilePath(@"c:\temp\system_results.json"));
            mockFileSystem.AddFile(TestingHelpers.ConvertFilePath(@"c:\temp\system_results.json"), new MockFileData(newJson));
            mockFileSystem.RemoveFile(TestingHelpers.ConvertFilePath(@"c:\temp\unit_results.json"));
            mockFileSystem.AddFile(TestingHelpers.ConvertFilePath(@"c:\temp\unit_results.json"), new MockFileData("[]"));
        ...
        public void TestResultsFilePlugin_EmptyJsonArray()
        {
            ...
            {
                { TestingHelpers.ConvertFilePath(@"c:\test\TestResultsFilePlugin.toml"), fileSystem.File.ReadAllText(TestingHelpers.ConvertFilePath(@"c:\test\TestResultsFilePlugin.toml")) },
                { TestingHelpers.ConvertFilePath(@"c:\temp\system_results.json"), new MockFileData("[]") },
                { TestingHelpers.ConvertFilePath(@"c:\temp\unit_results.json"), new MockFileData("[]") }
            });
        ...
        public void TestResultsFilePlugin_OptionalFields()
        {
            ...
            {
                { TestingHelpers.ConvertFilePath(@"c:\test\TestResultsFilePlugin.toml"), fileSystem.File.ReadAllText(TestingHelpers.ConvertFilePath(@"c:\test\TestResultsFilePlugin.toml")) },
                { TestingHelpers.ConvertFilePath(@"c:\temp\system_results.json"), new MockFileData(jsonWithOptionalFields) },
                { TestingHelpers.ConvertFilePath(@"c:\temp\unit_results.json"), new MockFileData("[]") }
            });
        ...
        public void TestResultsFilePlugin_InvalidJsonStructure()
        {
            ...
            {
                { TestingHelpers.ConvertFilePath(@"c:\test\TestResultsFilePlugin.toml"), fileSystem.File.ReadAllText(TestingHelpers.ConvertFilePath(@"c:\test\TestResultsFilePlugin.toml")) },
                { TestingHelpers.ConvertFilePath(@"c:\temp\system_results.json"), new MockFileData(invalidStructureJson) },
                { TestingHelpers.ConvertFilePath(@"c:\temp\unit_results.json"), new MockFileData("[]") }
            });
        ...
        public void TestResultsFilePlugin_ProjectField()
        {
            ...
            {
                { TestingHelpers.ConvertFilePath(@"c:\test\TestResultsFilePlugin.toml"), fileSystem.File.ReadAllText(TestingHelpers.ConvertFilePath(@"c:\test\TestResultsFilePlugin.toml")) },
                { TestingHelpers.ConvertFilePath(@"c:\temp\system_results.json"), new MockFileData(jsonWithProject) },
                { TestingHelpers.ConvertFilePath(@"c:\temp\unit_results.json"), new MockFileData("[]") }
            });
        ...
        public void TestResultsFilePlugin_NullProjectField()
        {
            ...
            {
                { TestingHelpers.ConvertFilePath(@"c:\test\TestResultsFilePlugin.toml"), fileSystem.File.ReadAllText(TestingHelpers.ConvertFilePath(@"c:\test\TestResultsFilePlugin.toml")) },
                { TestingHelpers.ConvertFilePath(@"c:\temp\system_results.json"), new MockFileData(jsonWithNullProject) },
                { TestingHelpers.ConvertFilePath(@"c:\temp\unit_results.json"), new MockFileData("[]") }
            });
        ...
        public void TestResultsFilePlugin_EmptyStringProjectField()
        {
            ...
            {
                { TestingHelpers.ConvertFilePath(@"c:\test\TestResultsFilePlugin.toml"), fileSystem.File.ReadAllText(TestingHelpers.ConvertFilePath(@"c:\test\TestResultsFilePlugin.toml")) },
                { TestingHelpers.ConvertFilePath(@"c:\temp\system_results.json"), new MockFileData(jsonWithEmptyProject) },
                { TestingHelpers.ConvertFilePath(@"c:\temp\unit_results.json"), new MockFileData("[]") }
            });
